...
{
ChartBackColorSet(clrSilver);
ChartForeColorSet(clrSilver);
ChartUpColorSet(clrSilver);
ChartDownColorSet(clrSilver);
ChartBullColorSet(clrSilver);
ChartBearColorSet(clrSilver);
ChartShowGridSet(false);
ChartModeSet(1);
ChartLineColorSet(clrSilver);
ChartShowBidLineSet(false);
ChartShowAskLineSet(false);
}
