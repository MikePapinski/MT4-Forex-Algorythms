...
color DarkBlueColor = C'51,63,80';
   ...
   ObjectSetString(0, "logo", OBJPROP_BMPFILE, 0, "\\Images\\MyNewsEA.bmp");
   ...
   EditCreate("EAHeader",20,50,300,20,"MyNews EA v.1.1",MintColor,clrBlack);
   ...
   EditCreate("StatusHeader",20,170,100,20,"Status:",DarkBlueColor,clrBlack,clrWhite);
   EditCreate("StatusNewsValue",120,170,300,20,"0",clrWhite,clrBlack);

   EditCreate("NewsCurrencyHeader",20,190,100,20,"Currency:",DarkBlueColor,clrBlack,clrWhite);
   EditCreate("NewsCurrencyValue",120,190,300,20,"0",clrWhite,clrBlack);
   
   EditCreate("NewsTypeHeader",20,210,100,20,"Type:",DarkBlueColor,clrBlack,clrWhite);
   EditCreate("NewsTypeValue",120,210,300,20,"0",clrWhite,clrBlack);
   
   EditCreate("NewsDateHeader",20,230,100,20,"Date:",DarkBlueColor,clrBlack,clrWhite);
   EditCreate("NewsDateValue",120,230,300,20,"0",clrWhite,clrBlack);
...
void UpdateDashboard( string User, datetime LicenseValue, int UpcomingNewsValue, string CurrencyValue, string NewsTypeValue, datetime NewsDateValue, string Status)

{

ObjectSetString(0,"ServerTimeValue",OBJPROP_TEXT,TimeToStr(TimeCurrent(),TIME_DATE|TIME_MINUTES));
ObjectSetString(0,"UserValue",OBJPROP_TEXT,User);
ObjectSetString(0,"LicenseValue",OBJPROP_TEXT,TimeToStr(LicenseValue,TIME_DATE));
ObjectSetString(0,"StatusNewsValue",OBJPROP_TEXT,Status);
ObjectSetString(0,"NewsCurrencyValue",OBJPROP_TEXT,CurrencyValue);
ObjectSetString(0,"NewsTypeValue",OBJPROP_TEXT,NewsTypeValue);
ObjectSetString(0,"NewsDateValue",OBJPROP_TEXT,TimeToStr(NewsDateValue,TIME_DATE|TIME_MINUTES));
 ManageProfitOnChart();
